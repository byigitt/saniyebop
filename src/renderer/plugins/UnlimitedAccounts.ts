...
// Ported for Saniyebop

import { definePluginSettings } from "@equicord/types/api/settings";
import { OptionType } from "@equicord/types/utils/types";
